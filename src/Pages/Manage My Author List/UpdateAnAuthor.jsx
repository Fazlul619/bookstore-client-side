...
const UpdateAnAuthor = () => {
  const axiosPublic = useAxiosPublic();
  const author = useLoaderData();
  const { _id, authorName, authorImage, bio, birthDate } = author;
  const handleAuthor = (event) => {
    ...
    console.log(updateAnAuthorData);
    axiosPublic
      .put(`http://localhost:5000/author-update-api/${_id}`, updateAnAuthorData)
      .then((res) => {
  ...
  return (
    <div>
      <div className="bg-[#F4F3F0] p-24 my-5 rounded-xl">
        <h2 className="text-3xl font-extrabold">Update Author</h2>
